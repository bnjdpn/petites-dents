...
The helpers create the bundle/app/version, reconcile the age rating, apply the
price and IAP products declared in `fastlane/release_config.json`, select the
exact processed build, submit review items, and read the result back. They do
not use TestFlight. Product-type, localization and price changes require an
approved app-specific commercial plan and matching configuration.
